...
<div class="wp-block-group alignfull" style="padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--50)">
	...
	<div class="wp-block-group">
		...
		<h1 class="wp-block-heading has-text-align-center has-x-large-font-size"><?php echo esc_html_x( 'Hello, Joko Purnomo', 'Heading of the hero section', 'twentytwentyfour' ); ?></h1>
		<!-- /wp:heading -->
		...
		<p class="has-text-align-center"><?php echo esc_html_x( 'Welcome to Wordpress Developer', 'Content of the hero section', 'twentytwentyfour' ); ?></p>
		<!-- /wp:paragraph -->
		...
		<div class="wp-block-buttons">
			...
			<div class="wp-block-button">
				<a class="wp-block-button__link wp-element-button" onclick="showAlert()"><?php echo esc_html_x( 'Coba Klik joko!', 'Button text of the hero section', 'twentytwentyfour' ); ?></a>
			</div>
			<!-- /wp:button -->
		</div>
		<!-- /wp:buttons -->
